document.addEventListener('DOMContentLoaded', () => {
  ...
  function checkForMatch() {
    ...
    reversePointsByPercent = `${Math.round(100-iSorted/attempt*100)}%`;
    console.log(pointsByPercent)
    pointsDisplay.textContent = `${iSorted}/${attempt} = ${Math.round(iSorted/attempt*100)}%` 
    document.getElementById('dict-score').style.backgroundColor = "hsl(120,0%,"+ pointsByPercent +")";
    document.getElementById('dict-score').style.color = "hsl(120,100%,"+ reversePointsByPercent +")";
